...
public class EdAbstractedSelectionTest10
{
  ...
  public void zeroElementdoSelectionSortTest()
  {
    ...
    int[] checkArray = {};
    MySelectionSort10.doSelectionSort(zeroArray);
  ...
  public void oneElementdoSelectionSortTest()
  {
    ...
    //the assertTrue method is used to check whether something holds
    int[] checkArray = {8};
    MySelectionSort10.doSelectionSort(oneArray);
  ...
  public void manyElementdoSelectionTest()
  {
    ...
    MySelectionSort10.doSelectionSort(manyArray);
  ...
  public void firstElementdoSelectionTest()
  {
    ...
    MySelectionSort10.doSelectionSort(firstArray);
  ...
  public void lastElementdoSelectionTest()
  {
    ...
    MySelectionSort10.doSelectionSort(lastArray);
  ...
  public void mixedElementdoSelectionTest()
  {
    ...
    MySelectionSort10.doSelectionSort(mixedArray);
  ...
  {
    int[] zeroArray = {};
    assert(MySelectionSort10.findSmallestElement(zeroArray, 1, 1) == 0);
  }
  ...
  public void oneElementfindSmallestElementTest()
  {
    ...
    assert(MySelectionSort10.findSmallestElement(oneArray, 1, 1)==8);
  }
  ...
  {
    int[] manyArray = {10,8,4,6,5,1,3,7,2,9};
    assert(MySelectionSort10.findSmallestElement(manyArray, 1, 1)==0);
  }
  ...
  {
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort10.findSmallestElement(firstArray, 1, 1)==8 || MySelectionSort10.findSmallestElement(firstArray, 1, 1)==0);
  }
  ...
  public void lastElementfindSmallestElementTest()
  {
    int[] lastArray = {6,5,5,5,5,5,5,5,5,5};
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort10.findSmallestElement(lastArray, 1, 1)==1 || MySelectionSort10.findSmallestElement(firstArray, 1, 1)==9);
  }
  ...
  public void mixedElementfindSmallestElementTest()
  {
    int[] mixedArray = {5,6,5,6,5,6,5,6,5,6};
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort10.findSmallestElement(mixedArray, 1, 1)==0 || MySelectionSort10.findSmallestElement(firstArray, 1, 1)==8);
  }
  ...
  {
    int[] zeroArray = {};
    assert(MySelectionSort10.isSmallerElementSwapIndex(zeroArray, 1, 1) == 0);
  }
  ...
  public void oneElementisSmallerElementSwapTest() throws Throwable
  {
    int[] oneArray = {8};
    //the assertTrue method i;s used to check whether something holds
    assert(MySelectionSort10.isSmallerElementSwapIndex(oneArray, 0, 0)==0);
  }
  ...
  {
    int[] manyArray = {10,8,4,6,5,1,3,7,2,9};
    assert(MySelectionSort10.isSmallerElementSwapIndex(manyArray, 1, 2)==1);
  }
  ...
  {
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort10.isSmallerElementSwapIndex(firstArray, 0, 1)==0);
  }
  ...
  {
    int[] lastArray = {6,5,5,5,5,5,5,5,5,5};
    assert(MySelectionSort10.isSmallerElementSwapIndex(lastArray, 8, 9)==8);
  }
  ...
  {
    int[] mixedArray = {5,6,5,6,5,6,5,6,5,6};
    assert(MySelectionSort10.isSmallerElementSwapIndex(mixedArray, 1, 2)==2);
  }
  ...
  {
    int[] zeroArray = {};
    assert(MySelectionSort10.swapElements(zeroArray, 0, 0) == zeroArray);
  }
  ...
  public void manyElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort10.swapElements(manyArray, 1, 2), checkArray);
  }
  ...
  public void firstArrayElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort10.swapElements(firstArray, 0, 1), checkArray);
  }
  ...
  public void lastArrayElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort10.swapElements(lastArray, 8, 9), checkArray);
  }
  ...
  public void mixedArrayElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort10.swapElements(mixedArray, 8, 9), checkArray);
  }
