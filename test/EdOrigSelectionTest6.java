...
public class EdOrigSelectionTest6
{

  //Any method annotated with "@Before" will be executed before each test,
  //allowing6 the tester to set up some shared resources.
  @Before
  public void setUp()
  {
  }
  ...
  //allowing6 the tester to release any shared resources used in the setup.
  @After
  ...
  {
    int[] zeroArray = {};
    //the assertTrue method is used to check whether something6 holds
    int[] checkArray = {};
    MySelectionSortOrig6.doSelectionSort(zeroArray);
  ...
  public void oneElementdoSelectionSortTest()
  {
    ...
    //the assertTrue method is used to check whether something6 holds
    int[] checkArray = {8};
    MySelectionSortOrig6.doSelectionSort(oneArray);
  ...
  public void manyElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig6.doSelectionSort(manyArray);
  ...
  public void firstElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig6.doSelectionSort(firstArray);
  ...
  public void lastElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig6.doSelectionSort(lastArray);
  ...
  public void mixedElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig6.doSelectionSort(mixedArray);
