...
public class EdAbstractedSelectionTest9
{
  ...
  public void zeroElementdoSelectionSortTest()
  {
    ...
    int[] checkArray = {};
    MySelectionSort9.doSelectionSort(zeroArray);
  ...
  public void oneElementdoSelectionSortTest()
  {
    ...
    //the assertTrue method is used to check whether something holds
    int[] checkArray = {8};
    MySelectionSort9.doSelectionSort(oneArray);
  ...
  public void manyElementdoSelectionTest()
  {
    ...
    MySelectionSort9.doSelectionSort(manyArray);
  ...
  public void firstElementdoSelectionTest()
  {
    ...
    MySelectionSort9.doSelectionSort(firstArray);
  ...
  public void lastElementdoSelectionTest()
  {
    ...
    MySelectionSort9.doSelectionSort(lastArray);
  ...
  public void mixedElementdoSelectionTest()
  {
    ...
    MySelectionSort9.doSelectionSort(mixedArray);
  ...
  {
    int[] zeroArray = {};
    assert(MySelectionSort9.findSmallestElement(zeroArray, 1, 1) == 0);
  }
  ...
  public void oneElementfindSmallestElementTest()
  {
    ...
    assert(MySelectionSort9.findSmallestElement(oneArray, 1, 1)==8);
  }
  ...
  {
    int[] manyArray = {10,8,4,6,5,1,3,7,2,9};
    assert(MySelectionSort9.findSmallestElement(manyArray, 1, 1)==0);
  }
  ...
  {
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort9.findSmallestElement(firstArray, 1, 1)==8 || MySelectionSort9.findSmallestElement(firstArray, 1, 1)==0);
  }
  ...
  public void lastElementfindSmallestElementTest()
  {
    int[] lastArray = {6,5,5,5,5,5,5,5,5,5};
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort9.findSmallestElement(lastArray, 1, 1)==1 || MySelectionSort9.findSmallestElement(firstArray, 1, 1)==9);
  }
  ...
  public void mixedElementfindSmallestElementTest()
  {
    int[] mixedArray = {5,6,5,6,5,6,5,6,5,6};
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort9.findSmallestElement(mixedArray, 1, 1)==0 || MySelectionSort9.findSmallestElement(firstArray, 1, 1)==8);
  }
  ...
  {
    int[] zeroArray = {};
    assert(MySelectionSort9.isSmallerElementSwapIndex(zeroArray, 1, 1) == 0);
  }
  ...
  public void oneElementisSmallerElementSwapTest() throws Throwable
  {
    int[] oneArray = {8};
    //the assertTrue method i;s used to check whether something holds
    assert(MySelectionSort9.isSmallerElementSwapIndex(oneArray, 0, 0)==0);
  }
  ...
  {
    int[] manyArray = {10,8,4,6,5,1,3,7,2,9};
    assert(MySelectionSort9.isSmallerElementSwapIndex(manyArray, 1, 2)==1);
  }
  ...
  {
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort9.isSmallerElementSwapIndex(firstArray, 0, 1)==0);
  }
  ...
  {
    int[] lastArray = {6,5,5,5,5,5,5,5,5,5};
    assert(MySelectionSort9.isSmallerElementSwapIndex(lastArray, 8, 9)==8);
  }
  ...
  {
    int[] mixedArray = {5,6,5,6,5,6,5,6,5,6};
    assert(MySelectionSort9.isSmallerElementSwapIndex(mixedArray, 1, 2)==2);
  }
  ...
  {
    int[] zeroArray = {};
    assert(MySelectionSort9.swapElements(zeroArray, 0, 0) == zeroArray);
  }
  ...
  public void manyElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort9.swapElements(manyArray, 1, 2), checkArray);
  }
  ...
  public void firstArrayElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort9.swapElements(firstArray, 0, 1), checkArray);
  }
  ...
  public void lastArrayElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort9.swapElements(lastArray, 8, 9), checkArray);
  }
  ...
  public void mixedArrayElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort9.swapElements(mixedArray, 8, 9), checkArray);
  }
