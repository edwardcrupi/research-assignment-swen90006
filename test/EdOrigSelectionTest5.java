...
public class EdOrigSelectionTest5
{

  //Any method annotated with "@Before" will be executed before each test,
  //allowing5 the tester to set up some shared resources.
  @Before
  public void setUp()
  {
  }
  ...
  //allowing5 the tester to release any shared resources used in the setup.
  @After
  ...
  {
    int[] zeroArray = {};
    //the assertTrue method is used to check whether something5 holds
    int[] checkArray = {};
    MySelectionSortOrig5.doSelectionSort(zeroArray);
  ...
  public void oneElementdoSelectionSortTest()
  {
    ...
    //the assertTrue method is used to check whether something5 holds
    int[] checkArray = {8};
    MySelectionSortOrig5.doSelectionSort(oneArray);
  ...
  public void manyElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig5.doSelectionSort(manyArray);
  ...
  public void firstElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig5.doSelectionSort(firstArray);
  ...
  public void lastElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig5.doSelectionSort(lastArray);
  ...
  public void mixedElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig5.doSelectionSort(mixedArray);
