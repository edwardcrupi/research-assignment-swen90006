...
public class EdOrigSelectionTest10
{

  //Any method annotated with "@Before" will be executed before each test,
  //allowing10 the tester to set up some shared resources.
  @Before
  public void setUp()
  {
  }
  ...
  //allowing10 the tester to release any shared resources used in the setup.
  @After
  ...
  {
    int[] zeroArray = {};
    //the assertTrue method is used to check whether something10 holds
    int[] checkArray = {};
    MySelectionSortOrig10.doSelectionSort(zeroArray);
  ...
  public void oneElementdoSelectionSortTest()
  {
    ...
    //the assertTrue method is used to check whether something10 holds
    int[] checkArray = {8};
    MySelectionSortOrig10.doSelectionSort(oneArray);
  ...
  public void manyElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig10.doSelectionSort(manyArray);
  ...
  public void firstElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig10.doSelectionSort(firstArray);
  ...
  public void lastElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig10.doSelectionSort(lastArray);
  ...
  public void mixedElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig10.doSelectionSort(mixedArray);
