...
public class EdAbstractedSelectionTest6
{
  ...
  public void zeroElementdoSelectionSortTest()
  {
    ...
    int[] checkArray = {};
    MySelectionSort6.doSelectionSort(zeroArray);
  ...
  public void oneElementdoSelectionSortTest()
  {
    ...
    //the assertTrue method is used to check whether something holds
    int[] checkArray = {8};
    MySelectionSort6.doSelectionSort(oneArray);
  ...
  public void manyElementdoSelectionTest()
  {
    ...
    MySelectionSort6.doSelectionSort(manyArray);
  ...
  public void firstElementdoSelectionTest()
  {
    ...
    MySelectionSort6.doSelectionSort(firstArray);
  ...
  public void lastElementdoSelectionTest()
  {
    ...
    MySelectionSort6.doSelectionSort(lastArray);
  ...
  public void mixedElementdoSelectionTest()
  {
    ...
    MySelectionSort6.doSelectionSort(mixedArray);
  ...
  {
    int[] zeroArray = {};
    assert(MySelectionSort6.findSmallestElement(zeroArray, 1, 1) == 0);
  }
  ...
  public void oneElementfindSmallestElementTest()
  {
    ...
    assert(MySelectionSort6.findSmallestElement(oneArray, 1, 1)==8);
  }
  ...
  {
    int[] manyArray = {10,8,4,6,5,1,3,7,2,9};
    assert(MySelectionSort6.findSmallestElement(manyArray, 1, 1)==0);
  }
  ...
  {
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort6.findSmallestElement(firstArray, 1, 1)==8 || MySelectionSort6.findSmallestElement(firstArray, 1, 1)==0);
  }
  ...
  public void lastElementfindSmallestElementTest()
  {
    int[] lastArray = {6,5,5,5,5,5,5,5,5,5};
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort6.findSmallestElement(lastArray, 1, 1)==1 || MySelectionSort6.findSmallestElement(firstArray, 1, 1)==9);
  }
  ...
  public void mixedElementfindSmallestElementTest()
  {
    int[] mixedArray = {5,6,5,6,5,6,5,6,5,6};
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort6.findSmallestElement(mixedArray, 1, 1)==0 || MySelectionSort6.findSmallestElement(firstArray, 1, 1)==8);
  }
  ...
  {
    int[] zeroArray = {};
    assert(MySelectionSort6.isSmallerElementSwapIndex(zeroArray, 1, 1) == 0);
  }
  ...
  public void oneElementisSmallerElementSwapTest() throws Throwable
  {
    int[] oneArray = {8};
    //the assertTrue method i;s used to check whether something holds
    assert(MySelectionSort6.isSmallerElementSwapIndex(oneArray, 0, 0)==0);
  }
  ...
  {
    int[] manyArray = {10,8,4,6,5,1,3,7,2,9};
    assert(MySelectionSort6.isSmallerElementSwapIndex(manyArray, 1, 2)==1);
  }
  ...
  {
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort6.isSmallerElementSwapIndex(firstArray, 0, 1)==0);
  }
  ...
  {
    int[] lastArray = {6,5,5,5,5,5,5,5,5,5};
    assert(MySelectionSort6.isSmallerElementSwapIndex(lastArray, 8, 9)==8);
  }
  ...
  {
    int[] mixedArray = {5,6,5,6,5,6,5,6,5,6};
    assert(MySelectionSort6.isSmallerElementSwapIndex(mixedArray, 1, 2)==2);
  }
  ...
  {
    int[] zeroArray = {};
    assert(MySelectionSort6.swapElements(zeroArray, 0, 0) == zeroArray);
  }
  ...
  public void manyElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort6.swapElements(manyArray, 1, 2), checkArray);
  }
  ...
  public void firstArrayElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort6.swapElements(firstArray, 0, 1), checkArray);
  }
  ...
  public void lastArrayElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort6.swapElements(lastArray, 8, 9), checkArray);
  }
  ...
  public void mixedArrayElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort6.swapElements(mixedArray, 8, 9), checkArray);
  }
