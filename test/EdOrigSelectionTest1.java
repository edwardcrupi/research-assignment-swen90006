...
public class EdOrigSelectionTest1
{
  ...
  public void zeroElementdoSelectionSortTest()
  {
    ...
    int[] checkArray = {};
    MySelectionSortOrig.doSelectionSort(zeroArray);
  ...
  public void oneElementdoSelectionSortTest()
  {
    ...
    //the assertTrue method is used to check whether something holds
    int[] checkArray = {8};
    MySelectionSortOrig.doSelectionSort(oneArray);
  ...
  public void manyElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig.doSelectionSort(manyArray);
  ...
  public void firstElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig.doSelectionSort(firstArray);
  ...
  public void lastElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig.doSelectionSort(lastArray);
  ...
  public void mixedElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig.doSelectionSort(mixedArray);
