...
public class EdOrigSelectionTest9
{

  //Any method annotated with "@Before" will be executed before each test,
  //allowing9 the tester to set up some shared resources.
  @Before
  public void setUp()
  {
  }
  ...
  //allowing9 the tester to release any shared resources used in the setup.
  @After
  ...
  {
    int[] zeroArray = {};
    //the assertTrue method is used to check whether something9 holds
    int[] checkArray = {};
    MySelectionSortOrig9.doSelectionSort(zeroArray);
  ...
  public void oneElementdoSelectionSortTest()
  {
    ...
    //the assertTrue method is used to check whether something9 holds
    int[] checkArray = {8};
    MySelectionSortOrig9.doSelectionSort(oneArray);
  ...
  public void manyElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig9.doSelectionSort(manyArray);
  ...
  public void firstElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig9.doSelectionSort(firstArray);
  ...
  public void lastElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig9.doSelectionSort(lastArray);
  ...
  public void mixedElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig9.doSelectionSort(mixedArray);
