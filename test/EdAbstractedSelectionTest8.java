...
public class EdAbstractedSelectionTest8
{
  ...
  public void zeroElementdoSelectionSortTest()
  {
    ...
    int[] checkArray = {};
    MySelectionSort8.doSelectionSort(zeroArray);
  ...
  public void oneElementdoSelectionSortTest()
  {
    ...
    //the assertTrue method is used to check whether something holds
    int[] checkArray = {8};
    MySelectionSort8.doSelectionSort(oneArray);
  ...
  public void manyElementdoSelectionTest()
  {
    ...
    MySelectionSort8.doSelectionSort(manyArray);
  ...
  public void firstElementdoSelectionTest()
  {
    ...
    MySelectionSort8.doSelectionSort(firstArray);
  ...
  public void lastElementdoSelectionTest()
  {
    ...
    MySelectionSort8.doSelectionSort(lastArray);
  ...
  public void mixedElementdoSelectionTest()
  {
    ...
    MySelectionSort8.doSelectionSort(mixedArray);
  ...
  {
    int[] zeroArray = {};
    assert(MySelectionSort8.findSmallestElement(zeroArray, 1, 1) == 0);
  }
  ...
  public void oneElementfindSmallestElementTest()
  {
    ...
    assert(MySelectionSort8.findSmallestElement(oneArray, 1, 1)==8);
  }
  ...
  {
    int[] manyArray = {10,8,4,6,5,1,3,7,2,9};
    assert(MySelectionSort8.findSmallestElement(manyArray, 1, 1)==0);
  }
  ...
  {
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort8.findSmallestElement(firstArray, 1, 1)==8 || MySelectionSort8.findSmallestElement(firstArray, 1, 1)==0);
  }
  ...
  public void lastElementfindSmallestElementTest()
  {
    int[] lastArray = {6,5,5,5,5,5,5,5,5,5};
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort8.findSmallestElement(lastArray, 1, 1)==1 || MySelectionSort8.findSmallestElement(firstArray, 1, 1)==9);
  }
  ...
  public void mixedElementfindSmallestElementTest()
  {
    int[] mixedArray = {5,6,5,6,5,6,5,6,5,6};
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort8.findSmallestElement(mixedArray, 1, 1)==0 || MySelectionSort8.findSmallestElement(firstArray, 1, 1)==8);
  }
  ...
  {
    int[] zeroArray = {};
    assert(MySelectionSort8.isSmallerElementSwapIndex(zeroArray, 1, 1) == 0);
  }
  ...
  public void oneElementisSmallerElementSwapTest() throws Throwable
  {
    int[] oneArray = {8};
    //the assertTrue method i;s used to check whether something holds
    assert(MySelectionSort8.isSmallerElementSwapIndex(oneArray, 0, 0)==0);
  }
  ...
  {
    int[] manyArray = {10,8,4,6,5,1,3,7,2,9};
    assert(MySelectionSort8.isSmallerElementSwapIndex(manyArray, 1, 2)==1);
  }
  ...
  {
    int[] firstArray = {5,5,5,5,5,5,5,5,5,6};
    assert(MySelectionSort8.isSmallerElementSwapIndex(firstArray, 0, 1)==0);
  }
  ...
  {
    int[] lastArray = {6,5,5,5,5,5,5,5,5,5};
    assert(MySelectionSort8.isSmallerElementSwapIndex(lastArray, 8, 9)==8);
  }
  ...
  {
    int[] mixedArray = {5,6,5,6,5,6,5,6,5,6};
    assert(MySelectionSort8.isSmallerElementSwapIndex(mixedArray, 1, 2)==2);
  }
  ...
  {
    int[] zeroArray = {};
    assert(MySelectionSort8.swapElements(zeroArray, 0, 0) == zeroArray);
  }
  ...
  public void manyElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort8.swapElements(manyArray, 1, 2), checkArray);
  }
  ...
  public void firstArrayElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort8.swapElements(firstArray, 0, 1), checkArray);
  }
  ...
  public void lastArrayElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort8.swapElements(lastArray, 8, 9), checkArray);
  }
  ...
  public void mixedArrayElementSwapTest()
  {
    ...
    assertArrayEquals(MySelectionSort8.swapElements(mixedArray, 8, 9), checkArray);
  }
