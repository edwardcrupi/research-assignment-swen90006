...
public class EdOrigSelectionTest8
{

  //Any method annotated with "@Before" will be executed before each test,
  //allowing8 the tester to set up some shared resources.
  @Before
  public void setUp()
  {
  }
  ...
  //allowing8 the tester to release any shared resources used in the setup.
  @After
  ...
  {
    int[] zeroArray = {};
    //the assertTrue method is used to check whether something8 holds
    int[] checkArray = {};
    MySelectionSortOrig8.doSelectionSort(zeroArray);
  ...
  public void oneElementdoSelectionSortTest()
  {
    ...
    //the assertTrue method is used to check whether something8 holds
    int[] checkArray = {8};
    MySelectionSortOrig8.doSelectionSort(oneArray);
  ...
  public void manyElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig8.doSelectionSort(manyArray);
  ...
  public void firstElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig8.doSelectionSort(firstArray);
  ...
  public void lastElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig8.doSelectionSort(lastArray);
  ...
  public void mixedElementdoSelectionTest()
  {
    ...
    MySelectionSortOrig8.doSelectionSort(mixedArray);
